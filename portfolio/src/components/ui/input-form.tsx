  ...
  return (
    <div className="relative flex flex-col gap-1 w-full">
      <input
        ...
        type={type}
        placeholder=" "
        className={clsx("peer bg-primary text-2xl font-bahnchrift rounded-3xl border border-orange-400 px-5 py-4 focus:outline-none text-white", errors?.[name] && "border-red-500 border-2")}
